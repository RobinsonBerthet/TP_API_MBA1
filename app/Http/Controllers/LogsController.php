...
/**
 * @OA\Get(
 *     path="/api/logs/fonctionnalite/{nom_fonctionnalite}",
 ...
 *         in="path",
 *         description="Le nom de la fonctionnalité pour laquelle récupérer les logs",
 *         required=true,
 *         @OA\Schema(
 *             type="string",
 *             example="Recherche"
 ...
 * )
 */
public function getLogsByFonctionnalite($nomFonctionnalite)
{
    $user = Auth::user();
    ...
    try {
        ...
        $fonctionnaliteRecherche = Fonctionnalite::where('nom_fonctionnalite', $nomFonctionnalite)->first();
